<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUpdLeadershipData.aspx.cs" Inherits="AdsSprit.AdsSpritAdmin.AddUpdLeadershipData" %>
            ...
            <div id="page-wrapper">
             <uc3:HeaderRight ID="HeaderRight1" runat="server" />
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="page-header">Add/Update Leader Data </h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row" style="margin-bottom:10px;">
                                        <div class="col-lg-12">                                           
                                             <a href="/AdsSpritAdmin/manage-Leader-events" class="dashCrdBtn bt_right_box">View LeaderShip Data</a>
                                             <a href="/AdsSpritAdmin/addupd-Leader" class="dashCrdBtn bt_right_box">View LeaderShip Category</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div role="form">
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;Leader Category</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:DropDownList ID="DdLeaderCategory" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtLeaderTitle" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true" ontextchanged="txtLeaderTitle_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;Leader Role</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-2" style="display: none;">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;Leader Title Url</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" style="display: none;">
                                        <div class="form-group">
                                    ...
                                    <div class="clearfix"></div>
                                        ...
                                        <div class="col-lg-4" style="display: none;">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtleaderrole" runat="server" CssClass="form-control" Width="400"></asp:TextBox>
                                            </div>
                                        </div>
