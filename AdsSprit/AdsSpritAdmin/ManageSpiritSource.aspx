<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageSpiritSource.aspx.cs" Inherits="AdsSprit.AdsSpritAdmin.ManageSpiritSource" %>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <asp:GridView ID="GvSpiritSource" runat="server" AutoGenerateColumns="False" AllowPaging="True" CaptionAlign="Left" OnPageIndexChanging="GvSpiritSource_PageIndexChanging" OnRowCommand="GvSpiritSource_RowCommand" OnRowDeleting="GvSpiritSource_RowDeleting"  AllowSorting="True" onsorting="GvSpiritSource_Sorting" PageSize="100">
                                                    <Columns>
                                                        <asp:BoundField DataField="sno" HeaderText="S.No.">
                                                            <ItemStyle  HorizontalAlign="center" />
                                                            <HeaderStyle  HorizontalAlign="center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="DetailName" SortExpression="DetailName" HeaderText="Detail Name">
                                                        ...
                                                        <asp:TemplateField HeaderText="Image" SortExpression="LargeImage">
                                                            <ItemTemplate>
                                                                <img width="70" alt="ads-spirit" src="../AdsSpritImages/SpiritSourceImage/<%#Eval("LargeImage")%>" />
                                                            </ItemTemplate>
                                                            <ItemStyle  HorizontalAlign="Center" />
                                                            <HeaderStyle  HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="ImgbtnEdit" runat="server" CommandArgument='<%#Eval("DetailID")%>'
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="IImgbtnDelete" runat="server" CommandArgument='<%#Eval("DetailID")%>'
