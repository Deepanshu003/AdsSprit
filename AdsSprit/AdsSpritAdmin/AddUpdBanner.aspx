<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUpdBanner.aspx.cs" Inherits="AdsSprit.AdsSpritAdmin.AddUpdBanner" %>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtBannerTitle" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true" ontextchanged="txtBannerTitle_TextChanged"></asp:TextBox>
                                    ...
                                    <div class="col-lg-2" style="display: none;">
                                        <div class="form-group">
                                            <label><span style="color: Blue;">*</span>&nbsp;Small Description </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" style="display: none;">
                                        <div class="form-group">
