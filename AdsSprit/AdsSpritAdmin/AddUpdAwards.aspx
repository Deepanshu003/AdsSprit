<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUpdAwards.aspx.cs" Inherits="AdsSprit.AdsSpritAdmin.AddUpdAwards" %>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row" style="margin-bottom:10px;">
                                        <div class="col-lg-12">                                           
                                             <a href="/AdsSpritAdmin/manage-awards" class="dashCrdBtn bt_right_box">View Awards</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div role="form">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;Awards Title</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtAwardsTitle" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true" ontextchanged="txtCelebrationTitle_TextChanged"></asp:TextBox>
