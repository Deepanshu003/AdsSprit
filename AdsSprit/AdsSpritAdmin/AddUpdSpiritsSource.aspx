<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUpdSpiritsSource.aspx.cs" Inherits="AdsSprit.AdsSpritAdmin.AddUpdSpiritsSource" %>
            ...
            <div id="page-wrapper">
             <uc3:HeaderRight ID="HeaderRight1" runat="server" />
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="page-header">Add/Update Awards</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row" style="margin-bottom:10px;">
                                        <div class="col-lg-12">                                           
                                             <a href="/AdsSpritAdmin/manage-awards" class="dashCrdBtn bt_right_box">View SPIRITSSOURCE</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div role="form">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;SPIRITSSOURCE Name</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtSPIRITSSOURCETitle" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true"></asp:TextBox>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtTitleURL" runat="server" CssClass="form-control" Width="650" style="display: none;"  ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                     <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;SPIRITSSOURCEColor</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtColor" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true"></asp:TextBox>                                     
                                        </div>
                                    </div>
                                             <div class="clearfix"></div>
                                     <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;SPIRITSSOURCENOSE</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtNose" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true"></asp:TextBox>
                                        </div>
                                    </div>
                                             <div class="clearfix"></div>
                                     <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;SPIRITSSOURCEPalate</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtPlalate" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true"></asp:TextBox>          
                                        </div>
                                    </div>
                                             <div class="clearfix"></div>
                                     <div class="col-lg-2">
                                        <div class="form-group">
                                            <label><span style="color: Red;">*</span>&nbsp;SPIRITSSOURCEABV</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtabv" runat="server" CssClass="form-control" Width="650" MaxLength="95" onkeyup="LimtCharacters(this,100,'LabelCHaracterLimit');" AutoPostBack="true"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                    </div>
                                    <div class="col-lg-4" style="display: none;">
                                        <div class="form-group">
                                            <input id="ThumbImg1" type="file" runat="server" /><span style="font-size:11px;">(Image Size 605px X 430px)</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="trImageTArea" runat="server" style="display: none;">
                                        <div class="form-group">
                                            <asp:Image ID="Image1" runat="server" Width="150" Height="80" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-lg-2">
                                    ...
                                    <div class="clearfix"></div>
                                        ...
                                        <div class="col-lg-4" style="display: none;">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtVideoURl" runat="server" CssClass="form-control" Width="400"></asp:TextBox>
                                            </div>
                                        </div>
                                    <div class="clearfix"></div>
                                    ...
                                    <div class="col-lg-4" style="display: none;">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtBlogSmallDesc" runat="server" CssClass="form-control" TextMode="MultiLine" Height="100" Width="650" style="display: none;"></asp:TextBox>
                                        </div>
                                    </div>
                                            <div class="clearfix"></div>
                                    <div class="col-lg-2" >
